    ...
    <div>
        <div class="container  m-t-0">
            <div class="column is-8" v-if="!editing">
                <p class="subtitle has-text-grey">Add Project Element
            ...
            <div class="column is-8" v-if="editing">
                <p class="subtitle has-text-grey">Edit Project Element</p>
                ...
                <table class="table table is-fullwidth is-bordered">
                    ...
                    <tbody>
                        <tr v-for="(element, key) in elements">
                            ...
                            <td>
                                <button class="button is-success is-small is-radiusless is-shadowless" @click="editElement(key,element.id, element.name, element.link)">Edit</button>
                            </td>
                            <td>
